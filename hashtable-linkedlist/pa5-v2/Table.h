...
public:
  ...
  // print out all the entries in the table, one per line.
   ...
   int getNumEntries() const;      // number of entries in the table
...
// add private data and methods here
  ...
  int getNumNonEmptyBuckets() const;
  ...
  Node* * hashEntries; // decl for array of pointers to Node (yes, need two *'s)
